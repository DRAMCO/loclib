...
#   cluster: an n-by-2 array containing the coordinates [x0, y0; x1, 2; ... xn-1, yn-1] of the cluster to which to compute
#           the distance to point P to
# output:
...
def distance_between_2d(point, cluster):
    ...
    # Check 'cluster' dimensions and orientation and try to fix
    if len(cshape) != 2:
